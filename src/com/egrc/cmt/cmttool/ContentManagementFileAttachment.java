...
public class ContentManagementFileAttachment {
	final static Logger logger = Logger.getLogger(ContentManagementFileAttachment.class);
	int rowCount;
	...
	public static void main(String[] args)
		...
		for (int i = 1; i < rowCount; i++) {
			...
			for (int j = 0; j < colCount; j++) {
				...
				data += (j == 0) ? cellData.replaceAll("[^0-9]", "")
						: cellData;
				data += "	";	
			...
			docId = arrData[0];	
			System.out.println("1	"+docId+"	"+docIdFolder+"	"+i+"	null	"+folderPath+"	0	"+timeStamp+"	user	0	null	null	null");
			allData.add("1	"+docId+"	"+fileName+"	"+cou+"	null	"+folderPath+"	0	"+timeStamp+"	user	0	null	null	null");
			//allData.add(data);
			cou++;
		}
		
		ContentManagementFileAttachment cmt = new ContentManagementFileAttachment();
