...
public class ContentManagementFileAttachmentBatch {
	final static Logger logger = Logger.getLogger(ContentManagementFileAttachmentBatch.class);
	int rowCount;
	...
	public static void main(String[] args)
		...
		for (int i = 1; i < rowCount; i++) {
			...
			{*/
				...
				docId = arrData[0];	
				System.out.println("1	"+docId+"	"+fileName+"	"+cou+"	null	"+folderPath+"	0	"+timeStamp+"	user	0	null	null	null");
		...
		ContentManagementFileAttachmentBatch cmt = new ContentManagementFileAttachmentBatch();
